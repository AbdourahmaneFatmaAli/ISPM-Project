        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                <?php foreach($users as $u): ?>
                    <tr>
                        <td class="px-4 align-middle text-muted">#<?= $u['id'] ?></td>
                        ...
                        <td class="align-middle text-muted small"><?= date('M j, Y', strtotime($u['created_at'])) ?></td>
                                    ...
                                    <div class="modal-content border-0 shadow">
                                      <form action="" method="POST">
                                          <div class="modal-header border-bottom-0">
                                            <h5 class="modal-title fw-bold">Change Role: <?= htmlspecialchars($u['name']) ?></h5>
